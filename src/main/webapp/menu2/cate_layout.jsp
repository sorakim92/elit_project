...
<div class="wrapper">
    ...
    <article class="">
        <table>
            <tr>
                <td>
                    <div style="width:200px; height: 200px; border: 1px solid #f8cacc; border-radius: 2em;
                                    margin:5px 20px 10px 20px;">
                        <img src="/img/addpic.png" alt="업체대표사진" width="110" height="130" name="" id=""><br>
                        <div style="text-align: left; padding: 5px 5px 5px 10px;">
                            <span style="font-weight: bold; ">가게이름</span>
                            <img src="/img/tag.png" height="25" width="35" alt="태그" name="" id=""
                        ...
                        <div style="font-size:12px; text-align: left; padding-left: 10px;">
                            ...
                            <span style="padding:0 10px 0 10px">배달비: 2000원</span>
                        </div>
                    </div>
                ...
                <td>
                    <div style="width:200px; height: 200px; border: 1px solid #f8cacc; border-radius: 2em;
                        ...
                        <img src="/img/addpic.png" alt="업체대표사진" width="110" height="130" name="" id=""><br>
                        <div style="text-align: left; padding: 5px 5px 5px 10px;">
                            <span style="font-weight: bold; ">가게이름
                            <img src="/img/tag.png" height="25" width="35" alt="태그" name="" id=""
                                        style="float:right; margin-right: 10px;">
                            </span>
                        </div>    
        ...
        <div style="margin-top: 20px; border-top: 2px solid #ccc; line-height: 2.0;">
        <!-- 상위 추천메뉴 이외에 -->
