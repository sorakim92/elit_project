        ...
        <div class='panel panel-default'>
          ...
          <div class='panel-body'>
              ...
              <fieldset>
                ...
                <div class='form-group row'>
                  ...
                  <div class='col-lg-3'>
                    ...
                    <input class='form-control' placeholder='.col-lg-7' disabled value = 'rkd'>
                  </div>
                  <div class='col-lg-3'>
                ...
                <div class='form-group'>
                  ...
                  <div class='checkbox-inline'>                
                    ...
                    <span style = "font-size : 15px;">메인상단</span>
                    	
                  </div>
                  <div class='checkbox-inline'>
                    <input type='checkbox' value=''>
           			         <span style = "font-size : 15px;">메인하단</span>
                  </div>                              
                </div>
           ...
           <div class='form-actions'>
                <button class='btn btn-default' style ="margin-right : 30px;" type='submit'>저장하기</button>
                <button class='btn btn-default' style ="margin-right : 30px;" type='submit'> 거절 </button>
