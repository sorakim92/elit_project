...
public class StoreVO {
	...
	public String getStoreclosedays() {
		return storeclosedays;
	}
	public void setStoreclosedays(String storeclosedays) {
		this.storeclosedays = storeclosedays;
	}
