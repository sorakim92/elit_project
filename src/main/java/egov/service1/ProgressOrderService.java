...
public interface ProgressOrderService {
	 ...
	 * (소라)
	 * */
	List<?> selectMyOrderlist(ProgressOrderVO vo) throws Exception;
	
	/*
	 * userid, orderindex로 디테일 정보 불러오기 (주문상세) 
	 * (소라)
	 * */
	ProgressOrderVO selectMyorderDetail(ProgressOrderVO vo) throws Exception;
